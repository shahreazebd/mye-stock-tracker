...
import { z } from "zod";
import { checkOttoProducts } from "@/actions/otto-actions";
...
import stores from "@/data/otto.json";
...
interface Props {
  ...
  setData: Dispatch<SetStateAction<OttoProductData[]>>;
  setSummary: Dispatch<SetStateAction<Summary | undefined>>;
}

export function OttoProductCheckForm(props: Props) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      setIsLoading(true);
      const result = await checkOttoProducts(payload);
